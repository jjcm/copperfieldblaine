...
class UserAnswersControllerTest < ActionController::TestCase
  ...
  test "should create user_answer" do
    assert_difference('UserAnswer.count') do
      post :create, user_answer: { answer_id: @user_answer.answer_id, survey_id: @user_answer.survey_id, user_id: @user_answer.user_id }
    end
  ...
  test "should update user_answer" do
    put :update, id: @user_answer, user_answer: { answer_id: @user_answer.answer_id, survey_id: @user_answer.survey_id, user_id: @user_answer.user_id }
    assert_redirected_to user_answer_path(assigns(:user_answer))
  end
